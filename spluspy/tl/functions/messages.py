...
if TYPE_CHECKING:
    from ...tl.types import TypeChatBannedRights, TypeChatReactions, TypeDataJSON, TypeDialogFilter, TypeInputBotApp, TypeInputBotInlineResult, TypeInputChatPhoto, TypeInputCheckPasswordSRP, TypeInputDialogPeer, TypeInputDocument, TypeInputGeoPoint, TypeInputMedia, TypeInputMessage, TypeInputPeer, TypeInputReplyTo, TypeInputSingleMedia, TypeInputStickerSet, TypeInputUser, TypeMessageEntity, TypeMessagesFilter, TypeReaction, TypeReplyMarkup, TypeReportReason, TypeSendMessageAction, TypeTextWithEntities
...
class DeleteMessagesRequest(TLRequest):
    ...
    def __init__(self, id: List[int], revoke: Optional[bool]=None, peer: Optional['TypeInputPeer']=None):
        """
    ...
    def _bytes(self):
        return b''.join((
            b'\x9b\x86G\xe5',
            struct.pack('<I', (0 if self.revoke is None or self.revoke is False else 1) | (0 if self.peer is None or self.peer is False else 1073741824)),
    ...
    def from_reader(cls, reader):
        ...
        if flags & 1073741824:
            ...
            _peer = None
        return cls(id=_id, revoke=_revoke, peer=_peer)
