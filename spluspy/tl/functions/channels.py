...
if TYPE_CHECKING:
    from ...tl.types import TypeChannelParticipantsFilter, TypeChatAdminRights, TypeChatBannedRights, TypeInputChannel, TypeInputChatPhoto, TypeInputGeoPoint, TypeInputMessage, TypeInputPeer, TypeInputUser
...
class ToggleMembershipMessageVisibilityRequest(TLRequest):
    CONSTRUCTOR_ID = 0x75646c0
    SUBCLASS_OF_ID = 0x8af52aac
    ...
    def to_dict(self):
        return {
            '_': 'ToggleMembershipMessageVisibilityRequest',
            'channel': self.channel.to_dict() if isinstance(self.channel, TLObject) else self.channel,
            'enabled': self.enabled
        }
