...
class SentDeleteAccountCode(TLObject):
    ...
    def __init__(self, type: 'TypeSentCodeType', timeout: int):
        """
        Constructor for auth.sentDeleteAccountCode: Instance of SentDeleteAccountCode.
        """
        self.type = type
        self.timeout = timeout
    ...
    def from_reader(cls, reader):
        _type = reader.tgread_object()
        _timeout = reader.read_int()
        return cls(type=_type, timeout=_timeout)
