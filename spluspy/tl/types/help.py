...
class PeerColorOption(TLObject):
    CONSTRUCTOR_ID = 0x135bd42f
    SUBCLASS_OF_ID = 0x56b8ae98

    def __init__(self, color_id: int, hidden: Optional[bool]=None, colors: Optional['TypePeerColorSet']=None, dark_colors: Optional['TypePeerColorSet']=None):
        """
    ...
    def _bytes(self):
        return b''.join((
            b'/\xd4[\x13',
            struct.pack('<I', (0 if self.hidden is None or self.hidden is False else 1) | (0 if self.colors is None or self.colors is False else 2) | (0 if self.dark_colors is None or self.dark_colors is False else 4)),
    ...
    def from_reader(cls, reader):
        ...
        if flags & 4:
            ...
            _dark_colors = None
        return cls(color_id=_color_id, hidden=_hidden, colors=_colors, dark_colors=_dark_colors)
