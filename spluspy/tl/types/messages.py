...
class ChatFull(TLObject):
    CONSTRUCTOR_ID = 0x5d7903a
    SUBCLASS_OF_ID = 0x225a5109

    def __init__(self, full_chat: 'TypeChatFull', chats: List['TypeChat'], users: List['TypeUser'], customInfo: Optional['TypeChannelFullCustom']=None):
        """
    ...
    def from_reader(cls, reader):
        ...
        if flags & 1:
            ...
            _customInfo = None
        return cls(full_chat=_full_chat, chats=_chats, users=_users, customInfo=_customInfo)
