...
class BotsTooMuchError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Too many bots' + self._fmt_request(self.request))
...
class BotChannelsNaError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bots cannot use this method' + self._fmt_request(self.request))
...
class BotCommandsTooMuchError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Too many bot commands' + self._fmt_request(self.request))
...
class BotCommandDescriptionInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot command description is invalid' + self._fmt_request(self.request))
...
class BotCommandInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot command is invalid' + self._fmt_request(self.request))
...
class BotDomainInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot domain is invalid' + self._fmt_request(self.request))
...
class BotGamesDisabledError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot games are disabled' + self._fmt_request(self.request))
...
class BotGroupsBlockedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot groups are blocked' + self._fmt_request(self.request))
...
class BotInlineDisabledError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot inline is disabled' + self._fmt_request(self.request))
...
class BotInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot is invalid' + self._fmt_request(self.request))
...
class BotMethodInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('This method cannot be used by bots' + self._fmt_request(self.request))
...
class BotMissingError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot is missing' + self._fmt_request(self.request))
...
class BotOnesideNotAvailError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot oneseide not available' + self._fmt_request(self.request))
...
class BotPaymentsDisabledError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot payments are disabled' + self._fmt_request(self.request))
...
class BotPollsDisabledError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot polls are disabled' + self._fmt_request(self.request))
...
class BotResponseTimeoutError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot response timeout' + self._fmt_request(self.request))
...
class BotScoreNotModifiedError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Bot score not modified' + self._fmt_request(self.request))

    def __reduce__(self):
        return type(self), (self.request,)


class InlineBotRequiredError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Inline bot required' + self._fmt_request(self.request))
...
class InlineResultExpiredError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Inline result expired' + self._fmt_request(self.request))
...
class ResultsTooMuchError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('Too many results' + self._fmt_request(self.request))
